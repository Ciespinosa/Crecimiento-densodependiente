...
<div class="centered">
```{r, echo=FALSE, warning=FALSE, message=FALSE, fig.height=4.5, fig.width=5}
...
ui <- fluidPage(
  ...
  sliderInput("a.s", label = "Alphas:",
    ...
    column(8,
           plotOutput("distPlot", width = "450px",height = "400px"))
  ))
...
}, outputArgs = list(width = "80%",height="300px"))
}
...
```{r, fig.margin=TRUE, fig.height=4, fig.width=4.5, echo=FALSE, warning=FALSE}


inputPanel(
  sliderInput("rd", label = "Tasa de incremento:",
              min = 1.3, max = 2.8, value = 1, step = 0.03)
  )
...
}, outputArgs = list(width = "70%",height="300px"))
